...
public class LoggablePID implements Sendable, AutoCloseable {
	 ...
	 */
	public LoggablePID(double kp, double ki, double kd) {
		this(kp, ki, kd, 0.02);
	}
	...
	public LoggablePID(double kp, double ki, double kd, double period) {
		m_kp = kp;
		m_ki = ki;
		m_kd = kd;
